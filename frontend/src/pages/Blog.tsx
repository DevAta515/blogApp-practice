...
export const Blog = () => {
    ...
    if (loading) {
        return <div className="flex justify-center w-full items-center px-36 mt-24">
            <div role="status" className="w-full p-4 flex flex-col justify-center border border-gray-200 rounded shadow animate-pulse md:p-6 ">
